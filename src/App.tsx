      ...
      <main>
        ...
        <section className="section spotlight">
          <div className="page-shell spotlight-grid">
            <div className="spotlight-art"><img className="spotlight-img" src={asset('/jiren-torneo-poder.jpg')} alt="Figura de Jiren en el Torneo del Poder" data-testid="img-spotlight-figure" /></div>
